...
class AbsoluteTextPdfElement implements PdfElement {
    ...
    AbsoluteTextPdfElement withSpaceBetweenLetters(float spaceBetweenLetters) {
        AbsoluteTextPdfElement pdfAbsoluteText = new AbsoluteTextPdfElement(this.tag, this.content, this.pdfPosition);
